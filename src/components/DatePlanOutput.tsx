...
const DatePlanOutput: React.FC<DatePlanOutputProps> = ({ profileData }) => {
  ...
  const generateWhatsAppText = () => {
    const whatsappText = `🌟 *Our AI-Generated Date Plan* 🌟

📍 *Location:* ${profileData.location}
⏰ *Duration:* ${profileData.duration} hours
🌤️ *Weather:* ${profileData.season}
  ...
  const downloadPDF = () => {
    ...
    const pdfContent = `
      <html>
        ...
        <body>
          <div class="header">
            <h1>🌟 Your AI-Generated Date Plan</h1>
    ...
    a.href = url;
    a.download = 'ai-more-date-plan.html';
