...
⏰ ${profileData.duration} hours | 🌤️ ${profileData.season}
...
Generated by AI-more.me ✨`;
  ...
  const saveAsImage = () => {
    ...
    ctx.font = '18px Arial';
    ctx.fillText(`📍 ${profileData.location}`, 400, 100);
    ctx.fillText(`⏰ ${profileData.duration} hours | 🌤️ ${profileData.season}`, 400, 130);
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <p><strong>Duration:</strong> ${profileData.duration} hours | <strong>Weather:</strong> ${profileData.season}</p>
          </div>
